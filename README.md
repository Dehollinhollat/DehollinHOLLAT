...
| Domaine | Compétences |
|---|---|
| **Pilotage de projet** | Cadrage · Planning · Gestion des risques · COPIL · Livrables · Reporting |
...
| [Phila-Integration](https://github.com/Dehollinhollat/phila-integration) | Application full-stack en production : inscription via QR Code, suivi référent automatisé, messagerie WhatsApp et certificats PDF pour la gestion d'intégration dans une association | React · TypeScript · Node.js · Express · Prisma · PostgreSQL · Twilio WhatsApp · Resend · jsPDF · Framer Motion · Recharts · Jest · Playwright · Vercel · Railway |
...
- **Master Management de Projet & Digital** - Obtenu
- **Licence Pro Management & Conduite de Projet en PME - PMI** - Obtenu

---

## 📫 Me contacter

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/dehollin-hollat/)
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:dehollin.hollat@outlook.fr)

---

*"Un Chef de Projet IA efficace comprend ce qu'il pilote -
il fait le pont entre la vision business et l'exécution technique."*
